"""
cardiosonix is the main engine of the project, containing nested packages with:
...
Packages:
    configs - package contains modules with classes representing configuration models for various parts of the project.
